...
var PFD_addpage_p_dps_fault = func(device)
{
	...
	if (major_function == 4)
		{
		p_dps_fault.string1.setText( SpaceShuttle.cws_message_array_long_bfs[0]);
		p_dps_fault.string2.setText( SpaceShuttle.cws_message_array_long_bfs[1]);
		p_dps_fault.string3.setText( SpaceShuttle.cws_message_array_long_bfs[2]);
		p_dps_fault.string4.setText( SpaceShuttle.cws_message_array_long_bfs[3]);
		p_dps_fault.string5.setText( SpaceShuttle.cws_message_array_long_bfs[4]);
		p_dps_fault.string6.setText( SpaceShuttle.cws_message_array_long_bfs[5]);
		p_dps_fault.string7.setText( SpaceShuttle.cws_message_array_long_bfs[6]);
		p_dps_fault.string8.setText( SpaceShuttle.cws_message_array_long_bfs[7]);
		p_dps_fault.string9.setText( SpaceShuttle.cws_message_array_long_bfs[8]);
		p_dps_fault.string10.setText( SpaceShuttle.cws_message_array_long_bfs[9]);
		p_dps_fault.string11.setText( SpaceShuttle.cws_message_array_long_bfs[10]);
		p_dps_fault.string12.setText( SpaceShuttle.cws_message_array_long_bfs[11]);
		p_dps_fault.string13.setText( SpaceShuttle.cws_message_array_long_bfs[12]);
		p_dps_fault.string14.setText( SpaceShuttle.cws_message_array_long_bfs[13]);
		p_dps_fault.string15.setText( SpaceShuttle.cws_message_array_long_bfs[14]);
		}
	else
		{
