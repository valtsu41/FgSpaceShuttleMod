...
var PFD_addpage_p_dps_override = func(device)
{
    ...
    p_dps_override.etsep_auto.enableUpdate();
    p_dps_override.etsep_sep.enableUpdate();    
    ...
    p_dps_override.update = func
    {
        ...
        p_dps_override.etsep_sep.updateText( symbol );

	symbol = "";
	if (getprop("/controls/shuttle/et-separation-auto-sw") == 1)
		{
            	symbol = "*";
		}

        p_dps_override.etsep_auto.updateText(symbol);
    ...
    # ADTA is shown only in OPS 3 or 6
		...
		if (SpaceShuttle.air_data_system.adta[0].operational == 1)
			{		
			p_dps_override.adta_h1.setText(sprintf("%06.0f", alt1));
		    	p_dps_override.adta_M1.setText(sprintf("%04.2f", mach1));
			p_dps_override.adta_a1.setText(sprintf("%+05.1f", alpha1));
			}
		else
			{
		...
		if (SpaceShuttle.air_data_system.adta[1].operational == 1)
			{
			p_dps_override.adta_h2.setText(sprintf("%06.0f", alt2));
		    	p_dps_override.adta_M2.setText(sprintf("%04.2f", mach2));
			p_dps_override.adta_a2.setText(sprintf("%+05.1f", alpha2));
			}
		else
			{
		...
		if (SpaceShuttle.air_data_system.adta[2].operational == 1)
			{
			p_dps_override.adta_h3.setText(sprintf("%06.0f", alt3));
		    	p_dps_override.adta_M3.setText(sprintf("%04.2f", mach3));
			p_dps_override.adta_a3.setText(sprintf("%+05.1f", alpha3));
			}
		else
			{
		...
		if (SpaceShuttle.air_data_system.adta[3].operational == 1)
			{
			p_dps_override.adta_h4.setText(sprintf("%06.0f", alt4));
		    	p_dps_override.adta_M4.setText(sprintf("%04.2f", mach4));
			p_dps_override.adta_a4.setText(sprintf("%+05.1f", alpha4));
			}
		else
			{
	...
	p_dps_override.roll_auto.updateText(symbol);
        ...
        p_dps_override.frcs_ttg.updateText(sprintf("%03d", getprop("/fdm/jsbsim/systems/rcs/fwd-dump-time-s")));
        p_dps_override.arcs_ttg.updateText(sprintf("%03d", getprop("/fdm/jsbsim/systems/rcs/aft-dump-time-s")));
        ...
        p_dps_override.omsdump_qty.updateText(sprintf("%03d", getprop("/fdm/jsbsim/systems/oms/oms-dump-qty")));
        p_dps_override.omsdump_ttg.updateText(sprintf("%03d", getprop("/fdm/jsbsim/systems/oms/oms-dump-ttg-s")));
