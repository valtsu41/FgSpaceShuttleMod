...
var PFD_addpage_p_dps_dap = func(device)
{
    ...
    p_dps_dap.dap_a_desig = device.svg.getElementById("p_dps_dap_dap_a_desig");
    p_dps_dap.dap_b_desig = device.svg.getElementById("p_dps_dap_dap_b_desig");
    ...
    # set defaults for all functions which aren't implemented yet
        ...
        #Underline added into the svg
    
        p_dps_dap.e_rot_rate.setText(sprintf("" ));
        p_dps_dap.e_rot_rate_v.setText(sprintf("" ));
    
        p_dps_dap.e_att_db.setText(sprintf("" ));
        p_dps_dap.e_att_db_v.setText(sprintf("" ));
    
        p_dps_dap.e_rate_db.setText(sprintf("" ));
        p_dps_dap.e_rate_db_alt.setText(sprintf("" ));
        p_dps_dap.e_rate_db_v.setText(sprintf("" ));
    
        p_dps_dap.e_rot_pls.setText(sprintf("" ));
        p_dps_dap.e_rot_pls_v.setText(sprintf("" ));
    
        p_dps_dap.e_comp.setText(sprintf("" ));
        p_dps_dap.e_comp_v.setText(sprintf("" ));
    
        p_dps_dap.a_cntl_acc.setText(sprintf("0" ));
        p_dps_dap.b_cntl_acc.setText(sprintf("0" ));
        p_dps_dap.e_cntl_acc.setText(sprintf("" ));
    
        p_dps_dap.e_tran_pls.setText(sprintf("" ));
    
        p_dps_dap.a_edit.setText(sprintf("" ));
        p_dps_dap.b_edit.setText(sprintf("" ));
    
        p_dps_dap.e_n_jets.setText(sprintf("" ));
    
        p_dps_dap.e_p_opt.setText(sprintf(" ALL"));
        p_dps_dap.e_y_opt.setText(sprintf(" ALL"));
    
        p_dps_dap.a_on_time.setText(sprintf("0.08"));
        p_dps_dap.b_on_time.setText(sprintf("0.08"));
        p_dps_dap.e_on_time.setText(sprintf(""));
    
        p_dps_dap.a_delay.setText(sprintf("00.00"));
        p_dps_dap.b_delay.setText(sprintf("00.00"));
        p_dps_dap.e_delay.setText(sprintf(""));
        ...
        p_dps_dap.intvl.setText(sprintf("000.00")); 
    }
    
    p_dps_dap.update = func
    {
    
        p_dps_dap.a_rot_rate.setText(sprintf("%06.4f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-PRI-rot-rate")));
        p_dps_dap.a_rot_rate_v.setText(sprintf("%06.4f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-VRN-rot-rate") ));
    
        p_dps_dap.b_rot_rate.setText(sprintf("%06.4f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-PRI-rot-rate")));
        p_dps_dap.b_rot_rate_v.setText(sprintf("%06.4f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-VRN-rot-rate") ));
    
        p_dps_dap.a_att_db.setText(sprintf("%05.2f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-PRI-att-db")));
        p_dps_dap.a_att_db_v.setText(sprintf("%06.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-VRN-att-db") ));
    
        p_dps_dap.b_att_db.setText(sprintf("%05.2f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-PRI-att-db")));
        p_dps_dap.b_att_db_v.setText(sprintf("%06.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-VRN-att-db") ));
    
        p_dps_dap.a_rate_db.setText(sprintf("%04.2f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-PRI-rate-db")));
        p_dps_dap.a_rate_db_alt.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-ALS-rate-db")));
        p_dps_dap.a_rate_db_v.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-VRN-rate-db") ));
    
        p_dps_dap.b_rate_db.setText(sprintf("%04.2f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-PRI-rate-db")));
        p_dps_dap.b_rate_db_alt.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-ALT-rate-db")));
        p_dps_dap.b_rate_db_v.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-VRN-rate-db") ));
    
        p_dps_dap.a_rot_pls.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-PRI-rot-pls")));
        p_dps_dap.b_rot_pls.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-PRI-rot-pls")));
    
        p_dps_dap.a_rot_pls_v.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-VRN-rot-pls")));
        p_dps_dap.b_rot_pls_v.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-VRN-rot-pls")));
    
        p_dps_dap.a_comp.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-PRI-comp")));
        p_dps_dap.b_comp.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-PRI-comp")));
    
        p_dps_dap.a_comp_v.setText(sprintf("%04.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-VRN-comp")));
        p_dps_dap.b_comp_v.setText(sprintf("%04.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-VRN-comp")));
        ...
        p_dps_dap.a_tran_pls.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-PRI-tran-pls")));
        p_dps_dap.b_tran_pls.setText(sprintf("%05.3f", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-PRI-tran-pls")));
    
        p_dps_dap.a_n_jets.setText(sprintf("%1d", getprop("/fdm/jsbsim/systems/ap/spec20/dap-A-ALT-n-jets")));
        p_dps_dap.b_n_jets.setText(sprintf("%1d", getprop("/fdm/jsbsim/systems/ap/spec20/dap-B-ALT-n-jets")));
    
        #var control_mode = getprop("/fdm/jsbsim/systems/fcs/control-mode");
	var selected_dap = getprop("/fdm/jsbsim/systems/ap/orbital-dap-buttons/dap-b-select");
	var selected_jets = getprop("/fdm/jsbsim/systems/ap/orbital-dap-buttons/vrn-select");

        if (selected_jets == 0)
    	{
	 
	   p_dps_dap.label1.setColor(0.8, 0.8, 0.4);
	   p_dps_dap.label2.setColor(dps_r, dps_g, dps_b);
	   p_dps_dap.label3.setColor(dps_r, dps_g, dps_b);
    	...
    	{
	   p_dps_dap.label1.setColor(dps_r, dps_g, dps_b);
	   p_dps_dap.label2.setColor(dps_r, dps_g, dps_b);
	   p_dps_dap.label3.setColor(0.8, 0.8, 0.4);
           # p_dps_dap.label1a.setText(sprintf("" )); 
           # p_dps_dap.label2a.setText(sprintf("" )); 
        ...
        if (selected_dap == 0)
    	{
	    p_dps_dap.dap_a_desig.setColor(0.8, 0.8, 0.4);
	    p_dps_dap.dap_b_desig.setColor(dps_r, dps_g, dps_b);
           # p_dps_dap.dap_a_desig_bright.setText(sprintf("DAP A01" )); 
           # p_dps_dap.dap_b_desig_bright.setText(sprintf("" )); 
    	}
        else if (selected_dap == 1)
    	{
	    p_dps_dap.dap_a_desig.setColor(dps_r, dps_g, dps_b);
	    p_dps_dap.dap_b_desig.setColor(0.8, 0.8, 0.4);
           # p_dps_dap.dap_a_desig_bright.setText(sprintf("" )); 
