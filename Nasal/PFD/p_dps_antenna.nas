...
var PFD_addpage_p_dps_antenna = func(device)
{
	...
	if (SpaceShuttle.antenna_manager.ku_operational == 1)
		{
		p_dps_antenna.el_act.setText(sprintf("%+05.1f", SpaceShuttle.antenna_manager.ku_elevation));
		p_dps_antenna.az_act.setText(sprintf("%+05.1f", SpaceShuttle.antenna_manager.ku_azimuth));
	...
	p_dps_antenna.el_cmd.setText(sprintf("%+05.1f", SpaceShuttle.antenna_manager.ku_elevation_cmd));
	p_dps_antenna.az_cmd.setText(sprintf("%+05.1f", SpaceShuttle.antenna_manager.ku_azimuth_cmd));
	...
	p_dps_antenna.s_ss.setText(sprintf("%04.2f", SpaceShuttle.antenna_manager.signal_strength_s));

	p_dps_antenna.ku_ss.setText(sprintf("%04.2f", SpaceShuttle.antenna_manager.ku_operational * 2.3));
