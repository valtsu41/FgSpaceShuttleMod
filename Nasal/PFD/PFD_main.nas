...
var PFD_update_time = 0.1;

SpaceShuttle.update_PFD_speed();
...
# create the object that will control all of this
    ...
    addPages : func
    {
		...
		me.PFD.p_dps_bearing = PFD_addpage_p_dps_bearing(me.PFD);
...
# SVG access to all common elements in DPS and MEDS page structures
	...
	me.PFD.p_ascent.addMenuAction(5, " MEDS\nMSG ACK", "meds_fault_ack");
		...
		me.PFD.p_dps_bearing.addMenuItem(0, "UP", me.PFD.p_main);
        me.PFD.p_dps_bearing.addMenuAction(4, " MEDS\nMSG RST", "meds_fault_clear");
       	me.PFD.p_dps_bearing.addMenuAction(5, " MEDS\nMSG ACK", "meds_fault_ack");
	...
	me.PFD.p_meds_maint_cfg.addMenuAction(5, " MEDS\nMSG ACK", "meds_fault_ack");
        ...
        me.PFD.p_meds_autonomous.addMenuAction(0, "AUT/\nMAN", "switch_aut_man");
...
var is_pfd = func(mdu) {
	return (
		mdu.PFD.current_page.title == "PFD"
		or
		mdu.PFD.current_page.title == "PFDOrbit"
	)
}
...
var rtExec_loop = func {
	...
	settimer(rtExec_loop, MDU_update_time / size(MDU_array)); # Keep display framerate consistent
}
