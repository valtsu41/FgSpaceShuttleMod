...
var velocity_vector_factor = 22.5; #23
...
if (declutter_level < 3)
	...
	if (SpaceShuttle.TAEM_guidance_TGINIT.PMODE > 0) 
		{
		me.dc2.v_vector.setVisible(1);

		#VV correction factor for high winds effect (Gamma air vs Gamma ground --> Horizontal V true / Horizontal V ground components) // Autoland phases 
		me.dc2.v_vector.setTranslation(hdp.VV_x + 121.0, hdp.VV_y * velocity_vector_factor * SpaceShuttle.TAEM_jsbsim.V_true / SpaceShuttle.TAEM_jsbsim.V_ground + 13.0); # +12 
		}
	else
		{
	...
	if (SpaceShuttle.TAEM_guidance_TGINIT.PMODE == 2)
		{
...
var HUD_DataProvider  = {
	...
	if ((me.radar_alt_available == 1) and (me.alt_agl_ft < 5000.0))
		{
		me.altitude_ft = me.alt_agl_ft - 17.0; #RA 17 feet when on ground with gear/ 12 mean value
		me.radar_flag = "R";
		}	
	else 
		{
	...
	me.bank_error = 25 * 0.05 * SpaceShuttle.TAEM_guidance_TDAP.BANKER_sum;
	me.pitch_error = (SpaceShuttle.TAEM_guidance_TDAP.QC / SpaceShuttle.TAEM_guidance_TDAP.GQN) * 50.0;
