...
#Function to reset guidance used in MNVR dps page
var oms_guidance_reset = func {
...
#SpaceShuttle.oms_burn_tgt_reset(); No reset of burn target when item 22 cancelled
